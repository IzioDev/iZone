...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 6, 0, 97);
    			add_location(button0, file$1, 9, 0, 146);
    			add_location(button1, file$1, 10, 0, 190);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			label1.textContent = "Categorie Name:";
    			t4 = space();
    			...
    			add_location(label0, file$2, 213, 3, 4286);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "id", "name");
    			attr_dev(input0, "name", "name");
    			attr_dev(input0, "placeholder", "zoneName");
    			add_location(input0, file$2, 214, 3, 4327);
    			attr_dev(label1, "for", "cat");
    			add_location(label1, file$2, 216, 4, 4402);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "id", "cat");
    			attr_dev(input1, "name", "cat");
    			attr_dev(input1, "placeholder", "catName");
    			add_location(input1, file$2, 217, 3, 4447);
    			attr_dev(p, "class", "submit svelte-1cf3m6a");
    			add_location(p, file$2, 219, 3, 4518);
    			attr_dev(form, "id", "save-form");
    			attr_dev(form, "name", "save");
    			attr_dev(form, "class", "svelte-1cf3m6a");
    			add_location(form, file$2, 212, 2, 4248);
    			attr_dev(div, "class", "form svelte-1cf3m6a");
    			add_location(div, file$2, 211, 1, 4226);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(p, "click", /*plop*/ ctx[13], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function create_if_block$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*isInUse*/ ctx[3]) return create_if_block_4;
    		return create_else_block;
    	}

    	let current_block_type = select_block_type(ctx);
    	let if_block0 = current_block_type(ctx);
    	let if_block1 = /*currentDisp*/ ctx[2] == "manage" && create_if_block_3(ctx);
    	let if_block2 = /*currentDisp*/ ctx[2] == "help" && create_if_block_2(ctx);
    	let if_block3 = /*currentDisp*/ ctx[2] == "about" && create_if_block_1$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(i0, "class", "material-icons center red clickable md-48 svelte-1cf3m6a");
    			add_location(i0, file$2, 225, 35, 4674);
    			attr_dev(p0, "class", "close svelte-1cf3m6a");
    			add_location(p0, file$2, 225, 1, 4640);
    			attr_dev(p1, "class", "infos svelte-1cf3m6a");
    			add_location(p1, file$2, 226, 1, 4743);
    			attr_dev(p2, "class", "title svelte-1cf3m6a");
    			add_location(p2, file$2, 227, 1, 4777);
    			attr_dev(hr, "class", "infos-sep svelte-1cf3m6a");
    			add_location(hr, file$2, 228, 1, 4812);
    			attr_dev(i1, "class", "material-icons center svelte-1cf3m6a");
    			add_location(i1, file$2, 231, 60, 4944);
    			attr_dev(p3, "id", "manage");
    			attr_dev(p3, "class", "item-menu svelte-1cf3m6a");
    			add_location(p3, file$2, 231, 4, 4888);
    			attr_dev(i2, "class", "material-icons center svelte-1cf3m6a");
    			add_location(i2, file$2, 238, 58, 5466);
    			attr_dev(p4, "id", "help");
    			attr_dev(p4, "class", "item-menu svelte-1cf3m6a");
    			add_location(p4, file$2, 238, 4, 5412);
    			attr_dev(i3, "class", "material-icons center svelte-1cf3m6a");
    			add_location(i3, file$2, 239, 59, 5577);
    			attr_dev(p5, "id", "about");
    			attr_dev(p5, "class", "item-menu svelte-1cf3m6a");
    			add_location(p5, file$2, 239, 4, 5522);
    			attr_dev(div0, "class", "menu svelte-1cf3m6a");
    			add_location(div0, file$2, 230, 3, 4864);
    			attr_dev(div1, "class", "display svelte-1cf3m6a");
    			add_location(div1, file$2, 241, 3, 5644);
    			attr_dev(div2, "class", "content svelte-1cf3m6a");
    			add_location(div2, file$2, 229, 2, 4838);
    			attr_dev(div3, "class", "main-container svelte-1cf3m6a");
    			add_location(div3, file$2, 224, 1, 4609);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div3, anchor);
    			append_dev(div3, p0);
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(" Create Zone");
    			attr_dev(i, "class", "material-icons center svelte-1cf3m6a");
    			add_location(i, file$2, 236, 57, 5332);
    			attr_dev(p, "id", "add");
    			attr_dev(p, "class", "item-menu svelte-1cf3m6a");
    			add_location(p, file$2, 236, 5, 5280);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, i);
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(" Stop Zone Creation");
    			t2 = space();
    			p1 = element("p");
    			i1 = element("i");
    			i1.textContent = "save";
    			t4 = text(" Save Zone");
    			attr_dev(i0, "class", "material-icons center svelte-1cf3m6a");
    			add_location(i0, file$2, 233, 55, 5082);
    			attr_dev(p0, "id", "add");
    			attr_dev(p0, "class", "item-menu svelte-1cf3m6a");
    			add_location(p0, file$2, 233, 5, 5032);
    			attr_dev(i1, "class", "material-icons center svelte-1cf3m6a");
    			add_location(i1, file$2, 234, 55, 5205);
    			attr_dev(p1, "id", "add");
    			attr_dev(p1, "class", "item-menu svelte-1cf3m6a");
    			add_location(p1, file$2, 234, 5, 5155);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(p1, "click", /*saveZone*/ ctx[12], false, false, false)
    				];
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-1cf3m6a");
    			add_location(h2, file$2, 245, 6, 5793);
    			attr_dev(td0, "class", "svelte-1cf3m6a");
    			add_location(td0, file$2, 249, 8, 5883);
    			attr_dev(td1, "class", "svelte-1cf3m6a");
    			add_location(td1, file$2, 252, 8, 5932);
    			attr_dev(td2, "class", "svelte-1cf3m6a");
    			add_location(td2, file$2, 255, 8, 5976);
    			attr_dev(td3, "class", "svelte-1cf3m6a");
    			add_location(td3, file$2, 258, 8, 6022);
    			attr_dev(td4, "class", "svelte-1cf3m6a");
    			add_location(td4, file$2, 261, 8, 6064);
    			add_location(tr, file$2, 248, 7, 5869);
    			attr_dev(thead, "class", "svelte-1cf3m6a");
    			add_location(thead, file$2, 247, 7, 5853);
    			add_location(tbody, file$2, 266, 7, 6140);
    			attr_dev(table, "class", "center svelte-1cf3m6a");
    			add_location(table, file$2, 246, 6, 5822);
    			attr_dev(div, "class", "center svelte-1cf3m6a");
    			add_location(div, file$2, 244, 5, 5764);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h2);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*zones, deleteRequested, tpToSelected, Math*/ 784) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(244:4) {#if currentDisp == \\\"manage\\\"}",
    		ctx
    	});
    ...
    // (268:8) {#each zones as zone, i}
    function create_each_block(ctx) {
    	let tr;
    	let td0;
    	let t0_value = /*zone*/ ctx[19].cat + "";
    	let t0;
    	let t1;
    	let td1;
    	let t2_value = /*zone*/ ctx[19].name + "";
    	let t2;
    	let t3;
    	let td2;
    	let t4;
    	let t5_value = Math.ceil(/*zone*/ ctx[19].center.x) + "";
    	let t5;
    	let t6;
    	let t7_value = Math.ceil(/*zone*/ ctx[19].center.y) + "";
    	let t7;
    	let t8;
    	let t9_value = Math.ceil(/*zone*/ ctx[19].center.z) + "";
    	let t9;
    	let t10;
    	let td3;
    	let i0;
    	...
    	function click_handler(...args) {
    		return /*click_handler*/ ctx[16](/*zone*/ ctx[19], ...args);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t14 = space();
    			attr_dev(td0, "class", "svelte-1cf3m6a");
    			add_location(td0, file$2, 269, 9, 6206);
    			attr_dev(td1, "class", "svelte-1cf3m6a");
    			add_location(td1, file$2, 272, 9, 6259);
    			attr_dev(td2, "class", "svelte-1cf3m6a");
    			add_location(td2, file$2, 275, 9, 6313);
    			attr_dev(i0, "id", i0_id_value = /*i*/ ctx[21]);
    			attr_dev(i0, "class", "material-icons center clickable md-48 svelte-1cf3m6a");
    			add_location(i0, file$2, 279, 10, 6461);
    			attr_dev(td3, "class", "svelte-1cf3m6a");
    			add_location(td3, file$2, 278, 9, 6445);
    			attr_dev(i1, "id", i1_id_value = /*zone*/ ctx[19].id);
    			attr_dev(i1, "class", "material-icons center red clickable md-48 svelte-1cf3m6a");
    			add_location(i1, file$2, 282, 10, 6600);
    			attr_dev(td4, "class", "svelte-1cf3m6a");
    			add_location(td4, file$2, 281, 9, 6584);
    			add_location(tr, file$2, 268, 8, 6191);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(i0, "click", /*tpToSelected*/ ctx[8], false, false, false),
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*zones*/ 16 && t0_value !== (t0_value = /*zone*/ ctx[19].cat + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*zones*/ 16 && t2_value !== (t2_value = /*zone*/ ctx[19].name + "")) set_data_dev(t2, t2_value);
    			if (dirty & /*zones*/ 16 && t5_value !== (t5_value = Math.ceil(/*zone*/ ctx[19].center.x) + "")) set_data_dev(t5, t5_value);
    			if (dirty & /*zones*/ 16 && t7_value !== (t7_value = Math.ceil(/*zone*/ ctx[19].center.y) + "")) set_data_dev(t7, t7_value);
    			if (dirty & /*zones*/ 16 && t9_value !== (t9_value = Math.ceil(/*zone*/ ctx[19].center.z) + "")) set_data_dev(t9, t9_value);

    			if (dirty & /*zones*/ 16 && i1_id_value !== (i1_id_value = /*zone*/ ctx[19].id)) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(268:8) {#each zones as zone, i}",
    		ctx
    	});
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			span1 = element("span");
    			span1.textContent = "[L]";
    			t8 = text(" key (the keys can be changed in configuration file).");
    			t9 = space();
    			li2 = element("li");
    			...
    			t16 = text(" button, a prompt will ask you to enter a categorie name and a zone name.");
    			t17 = space();
    			li4 = element("li");
    			...
    			attr_dev(h2, "class", "svelte-1cf3m6a");
    			add_location(h2, file$2, 293, 6, 6911);
    			attr_dev(span0, "class", "orange svelte-1cf3m6a");
    			add_location(span0, file$2, 295, 46, 7008);
    			add_location(li0, file$2, 295, 14, 6976);
    			attr_dev(span1, "class", "orange svelte-1cf3m6a");
    			add_location(span1, file$2, 296, 40, 7102);
    			add_location(li1, file$2, 296, 14, 7076);
    			attr_dev(span2, "class", "orange svelte-1cf3m6a");
    			add_location(span2, file$2, 297, 47, 7240);
    			add_location(li2, file$2, 297, 14, 7207);
    			attr_dev(span3, "class", "orange svelte-1cf3m6a");
    			add_location(span3, file$2, 298, 46, 7329);
    			add_location(li3, file$2, 298, 14, 7297);
    			attr_dev(span4, "class", "orange svelte-1cf3m6a");
    			add_location(span4, file$2, 299, 55, 7501);
    			add_location(li4, file$2, 299, 14, 7460);
    			attr_dev(ul, "class", "help-list");
    			add_location(ul, file$2, 294, 12, 6938);
    			attr_dev(div, "class", "center container svelte-1cf3m6a");
    			add_location(div, file$2, 292, 5, 6872);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h2);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(292:4) {#if currentDisp == \\\"help\\\"}",
    		ctx
    	});
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = text(" is made by Izio to help developer and server owners to create polygonal 2D zones. It also provides few utilities to interract with the created zones.");
    			t4 = space();
    			p1 = element("p");
    			t5 = text("If you want to ");
    			span1 = element("span");
    			span1.textContent = "contribute";
    			t7 = text(" to this project, go to the CitizenFx forum, and follow the GitHub link.");
    			t8 = space();
    			p2 = element("p");
    			...
    			t13 = text("!");
    			attr_dev(h2, "class", "svelte-1cf3m6a");
    			add_location(h2, file$2, 306, 6, 7677);
    			attr_dev(span0, "class", "orange svelte-1cf3m6a");
    			add_location(span0, file$2, 307, 9, 7702);
    			add_location(p0, file$2, 307, 6, 7699);
    			attr_dev(span1, "class", "orange svelte-1cf3m6a");
    			add_location(span1, file$2, 308, 24, 7915);
    			add_location(p1, file$2, 308, 6, 7897);
    			attr_dev(span2, "class", "orange svelte-1cf3m6a");
    			add_location(span2, file$2, 309, 22, 8053);
    			attr_dev(span3, "class", "orange svelte-1cf3m6a");
    			add_location(span3, file$2, 309, 69, 8100);
    			add_location(p2, file$2, 309, 6, 8037);
    			attr_dev(div, "class", "center container svelte-1cf3m6a");
    			add_location(div, file$2, 305, 5, 7638);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h2);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(305:4) {#if currentDisp == \\\"about\\\"}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block0 = /*displayPrompt*/ ctx[1] && create_if_block_5(ctx);
    	let if_block1 = /*displayMenu*/ ctx[0] && create_if_block$1(ctx);
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	function plop(val) {
    		...
    		if (name.length == 0 || cat.length == 0) {
    			...
    			postRequest("error", {
    				message: "Fields can't contains whitespace"
    			});
    		} else {
    			postRequest("save", { name, cat });
    			$$invalidate(1, displayPrompt = false);
    		}
    	}

    	const writable_props = ["displayMenu", "displayPrompt", "currentDisp", "isInUse", "points", "zones"];
    	...
    	$$self.$set = $$props => {
    		...
    		if ("displayPrompt" in $$props) $$invalidate(1, displayPrompt = $$props.displayPrompt);
    		if ("currentDisp" in $$props) $$invalidate(2, currentDisp = $$props.currentDisp);
    		if ("isInUse" in $$props) $$invalidate(3, isInUse = $$props.isInUse);
